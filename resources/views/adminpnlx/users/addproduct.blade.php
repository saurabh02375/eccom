            ...
            <div class="row align-items-center">
              <div class="col mt-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Enter First Name" name="name" id="title" required>
                </div>
              </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col mt-4">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter description" name="description" id="title" required>
                          </div>
                        </div>
            <div class="mb-3">
