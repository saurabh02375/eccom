        ...
        <div class="container">
            ...
            <div class="ht-right">
                @if ($login)
                    ...
                    <a href="/login" class="login-panel"><i class="fa fa-user"></i>{{ Auth::user()->name }}</a>
                @else
        ...
        <div class="container">
            ...
            <nav class="nav-menu mobile-menu">
                <ul>
                    ...
                    <li class="{{ request()->is('viewshop') ? 'active' : '' }}"><a href="./viewshop">Shop</a></li>
                    ...
                    <li class="{{ request()->is('blogpage*') ? 'active' : '' }}"><a href="blogpage">Blog</a></li>
                    <li class="{{ request()->is('contactpage*') ? 'active' : '' }}"><a href="contactpage">Contact</a>
                    </li>
                    <li><a href="#">Pages</a>
                        <ul class="dropdown">
